...
class _MedicalCustomerPageState extends State<MedicalCustomerPage> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: _navigateToSavedPrescriptions,
                        style: ElevatedButton.styleFrom(
  ...
  void _navigateToSavedPrescriptions() async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder:
            (context) => SavedPrescriptionsPage(
              roomId: widget.roomId,
              customerName: widget.customerName,
              customerContact: widget.customerContact,
            ),
    ...
    print(
      'Returned from saved prescriptions - orders should update automatically',
    );
  }
