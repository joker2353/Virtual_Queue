...
class CreateRoomDialog extends StatefulWidget {
  ...
  static Future<void> show(BuildContext context) async {
    // Get the providers from a context that's guaranteed to be below the provider declarations
    return showDialog(
      context: context,
      builder:
          (dialogContext) =>
              Builder(builder: (builderContext) => const CreateRoomDialog()),
    );
  }
...
class _CreateRoomDialogState extends State<CreateRoomDialog>
  ...
  String? _error;
  String _selectedCategory = 'queue'; // Default to queue
                ...
                child: Column(
                  children: [
                    ...
                    FadeTransition(
                      opacity: _fadeInAnimation,
                      child: Text(
                        'Set up a new queue or shop for your members',
                        style: TextStyle(
                          fontSize: 14,
