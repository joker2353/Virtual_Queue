...
class JoinRoomCodeDialog extends StatefulWidget {
  ...
  const JoinRoomCodeDialog({super.key, this.roomProvider});
...
class _JoinRoomCodeDialogState extends State<JoinRoomCodeDialog>
  ...
  Future<void> _verifyRoomCode() async {
    ...
    try {
      // Use the passed provider or fall back to context
      final roomProvider =
          widget.roomProvider ??
          Provider.of<RoomProvider>(context, listen: false);

      // Verify the room code exists
      final roomDetails = await roomProvider.verifyRoomCode(
      ...
      // Show the details dialog with provider wrapper
