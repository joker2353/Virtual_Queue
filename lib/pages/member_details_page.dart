      ...
      MaterialPageRoute(
        builder:
            (context) => MultiProvider(
              ...
              child: MemberDetailsPage(roomId: roomId),
            ),
      ),
    );
  }
...
class _MemberDetailsPageState extends State<MemberDetailsPage>
  ...
  Widget _buildDetailsView() {
    ...
    if (_waitingSince != null) {
      ...
      if (duration.inDays > 0) {
        waitingTime =
            '${duration.inDays} days, ${duration.inHours.remainder(24)} hours';
  ...
  Widget _buildProgressCard(String waitingTime, UserRoom userRoom) {
    ...
    Color progressColor =
        isUserTurn ? Colors.green.shade600 : Colors.deepPurple.shade600;
    Color bgColor =
        isUserTurn ? Colors.green.shade50 : Colors.deepPurple.shade50;
                ...
                builder: (context, child) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _colorAnimation.value ?? progressColor,
                        width: 1.5,
                      ),
                    ),
                    child: Row(
